        ...
        Action registerAction = new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    // Captura a exceção se algum campo estiver vazio
                    JOptionPane.showMessageDialog(null, ex.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
                } catch (IOException ex) {
                    // Captura exceções relacionadas à conexão
                    JOptionPane.showMessageDialog(null, "Erro ao se conectar ao servidor: " + ex.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
                }
            }
        };
